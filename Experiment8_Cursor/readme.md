...
![image](https://github.com/user-attachments/assets/ffdfd7b7-2412-45b1-a105-ed49a689c5ec)
...
DECLARE
   CURSOR sal_cursor(min_sal NUMBER, max_sal NUMBER) IS
      SELECT first_name, salary FROM hr.employees WHERE salary BETWEEN min_sal AND max_sal;
   v_name hr.employees.first_name%TYPE;
   v_salary hr.employees.salary%TYPE;
   found BOOLEAN := FALSE;
BEGIN
...
![image](https://github.com/user-attachments/assets/0009c25e-d1a5-4fd8-a662-4a9568fbade1)
...
![image](https://github.com/user-attachments/assets/c259c7ab-648f-4575-b39b-a0419b866176)
...
![image](https://github.com/user-attachments/assets/1b04da8f-01a3-468c-b15f-a57abbbf5fea)
...
![image](https://github.com/user-attachments/assets/87bbee5d-016a-4b64-831a-fe3c6f172f03)
